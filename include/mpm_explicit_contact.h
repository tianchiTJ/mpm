#ifndef MPM_MPM_EXPLICIT_CONTACT_H_
#define MPM_MPM_EXPLICIT_CONTACT_H_

#include "mpm_base.h"

namespace mpm {

//! MPMExplicitContact class
//! \brief A class that implements the fully explicit one phase mpm
//! Contact algorithm
//! \details A single-phase explicit MPM
//! \tparam Tdim Dimension
template <unsigned Tdim>
class MPMExplicitContact : public MPMBase<Tdim> {
 public:
  //! Default constructor
  MPMExplicitContact(std::unique_ptr<IO>&& io);
...
#include "mpm_explicit_contact.tcc"

#endif  // MPM_MPM_EXPLICIT_CONTACT_H_
